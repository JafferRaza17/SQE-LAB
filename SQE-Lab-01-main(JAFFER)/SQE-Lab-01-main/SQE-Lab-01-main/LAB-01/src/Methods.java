...
public class Methods {
    ...
    public static void main(String[] args) throws Exception {
        ...
        LoginTest.initiateWebSession("SQE-Lab-01-main/LAB-01/src/driver/chromedriver.exe");
        ...
        CheckoutTest.FirstName("JAFFER");
        CheckoutTest.LastName("RAZA ASKARI");
        CheckoutTest.zip("1234");
